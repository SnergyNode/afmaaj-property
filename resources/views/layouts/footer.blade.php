            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        <h4 class="widget-title">About Afmaaj</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque minus facere id vitae possimus modi.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-12 col-md-12 text-center">
                    <p class="mb-0">© 2019 Afmaaj. All Rights Reserved
                </div>
